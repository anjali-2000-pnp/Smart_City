    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(UserDetailActivity.this, "Please Enter contact!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (type==2)
                {
                    ...
                    if (!checkBox1.isChecked() && !checkBox2.isChecked() && !checkBox3.isChecked() && !checkBox4.isChecked() &&
                            !checkBox5.isChecked() )
                    {
                        Toast.makeText(UserDetailActivity.this, "Please fill a choice!", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
                         ...
                         final String address, final String email_notfication)
    {
        class AddUser extends AsyncTask<Void,Void,String>
        {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                progressDialog = ProgressDialog.show(UserDetailActivity.this,"Adding User","Please Wait...",false,
                        false);
            }
